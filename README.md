...
creates a placeholder for the item until it becomes available. Because of this you need to ensure that `external_ids` of
newly created items match those that reference them.
